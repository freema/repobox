    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-neutral-950 text-white">
      <div className="w-full max-w-md p-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-2">Repobox</h1>
        ...
        <div className="space-y-4">
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-neutral-800 hover:bg-neutral-700 border border-neutral-700 rounded-lg transition-colors"
            >
              <GitHubIcon />
        ...
        <p className="mt-8 text-center text-sm text-neutral-500">
          By signing in, you agree to allow Repobox to access your repositories.
        </p>
      </div>
    </main>
  );
