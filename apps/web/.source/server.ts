...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, }, {"configuration.mdx": __fd_glob_1, "getting-started.mdx": __fd_glob_2, "index.mdx": __fd_glob_3, "installation.mdx": __fd_glob_4, });